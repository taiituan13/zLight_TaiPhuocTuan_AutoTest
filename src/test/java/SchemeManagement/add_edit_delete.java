...
public class add_edit_delete {
        ...
        public void Scheme() throws InterruptedException {
                ...
                WebElement createScheme = wait
                                .until(ExpectedConditions.presenceOfElementLocated(By.xpath("//form/button")));
                ...
                WebElement edit = wait.until(
                                ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                                "/html/body/div[1]/div/div/main/div/div[2]/div[2]/div/div/div/div/div/div/div/div/table/tbody/tr[2]/td[7]/div/div[1]/span")));
                edit.click();
                ...
                Assert.assertTrue(toastText.contains("thành công"), "Scheme waxs not added successfully!");
