...
public class addScheme {
        ...
        public void Scheme() throws InterruptedException {
                ...
                String filePath = "C:\\Users\\huytu\\OneDrive\\Tài liệu\\BuiNguyenHuyTuan_Review.docx";
                ...
                try {
                        WebElement successBox = wait.until(ExpectedConditions
                                        .visibilityOfElementLocated(By.xpath("/html/body/div[1]/section/div/div")));
