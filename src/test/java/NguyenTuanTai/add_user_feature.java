...
public class add_user_feature {
    ...
    public void addUser() {
        ...
        WebElement unitSelect = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[2]/div/div[2]/div/div[1]/div/div[2]/form/div[4]/div/div[2]")));
        unitSelect.click();
