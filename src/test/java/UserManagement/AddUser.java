...
public class AddUser {
        ...
        public void addUser() {
                ...
                WebElement addUserButton = wait
                                .until(ExpectedConditions.elementToBeClickable(By.xpath("//main//button")));
                addUserButton.click();

                // Nhập tên người dùng
                WebElement fullNameInput = wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("/html/body/div[2]/div/div[2]/div/div[1]/div/div[2]/form/div[1]/div/div[2]/div/div/input")));
                ...
                WebElement userNameInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "/html/body/div[2]/div/div[2]/div/div[1]/div/div[2]/form/div[2]/div[1]/div/div[2]/div/div/input")));
                userNameInput.sendKeys("nguyenvaSADna");

                // Nhập mật khẩu
                WebElement passwordInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "/html/body/div[2]/div/div[2]/div/div[1]/div/div[2]/form/div[2]/div[2]/div/div[2]/div/div/span/input")));
                passwordInput.sendKeys("Password123");

                // Nhập tên đăng nhập web IOT
                WebElement iotUserNameInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "/html/body/div[2]/div/div[2]/div/div[1]/div/div[2]/form/div[2]/div[3]/div/div[2]/div/div/input")));
                iotUserNameInput.sendKeys("ioSStuser");
                // Nhập mật khẩu web IOT
                WebElement iotPasswordInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
                                "/html/body/div[2]/div/div[2]/div/div[1]/div/div[2]/form/div[2]/div[4]/div/div[2]/div/div/span/input")));
                iotPasswordInput.sendKeys("iotpassword123");
                // Nhấn nút phân quyền

                WebElement roleSelect = wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("/html/body/div[2]/div/div[2]/div/div[1]/div/div[2]/form/div[3]/div/div[2]")));
                roleSelect.click();

                WebElement option = wait.until(ExpectedConditions.presenceOfElementLocated(
                                By.xpath(
                                                "//div[contains(@class, 'ant-select-item-option-content')]//span[contains(text(), 'Kĩ thuật')]")));
                ((JavascriptExecutor) driver).executeScript("arguments[0].click();", option);

                WebElement unitSelect = wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath("/html/body/div[2]/div/div[2]/div/div[1]/div/div[2]/form/div[4]/div/div[2]")));
                unitSelect.click();

                WebElement unitOption = wait.until(ExpectedConditions.visibilityOfElementLocated(
                                By.xpath(
                                                "//div[contains(@class, 'ant-select-item-option-content')][contains(text(), '123')]")));
                ((JavascriptExecutor) driver).executeScript("arguments[0].click();", unitOption);
                // Nhấn nút thêm người dùng
                WebElement submitButton = wait.until(ExpectedConditions
                                .elementToBeClickable(By.xpath(
                                                "/html/body/div[2]/div/div[2]/div/div[1]/div/div[2]/form/button")));
                submitButton.click();
